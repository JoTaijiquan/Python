...
self.name = n
self.color = c
สองบรรทัดนี้เป็นการกำหนดค่าที่เรียกว่า property ของ class หรือว่าง่ายๆ คือ
...
print(tom.color) ได้ B&W  จะเห็นว่าสามารถเรียกใช้ property หรือตัวแปร color ได้โดยตรงเลย
